...
export default class Dashboard extends NavigationMixin(LightningElement) {
    ...
    getColumnDataForYear(year) {
        ...
        const sample = {
            2023: {
                seriesA: [30, 40, 35, 50, 45, 60, 55, 70, 65, 80, 75, 90],
                seriesB: [20, 25, 30, 35, 40, 45, 50, 55, 50, 60, 65, 70]
            },
            2024: {
                seriesA: [35, 45, 40, 55, 50, 65, 60, 75, 70, 85, 80, 95],
                seriesB: [25, 30, 35, 40, 45, 50, 55, 60, 55, 65, 70, 75]
            },
            2025: {
    ...
    drawColumnChart() {
        ...
        const allValues = data.seriesA.concat(data.seriesB);
